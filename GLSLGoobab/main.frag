...
void main()
{
    ...
    vec2 normalizedFragCoord = (2.0 * gl_FragCoord.xy - vec2(1800.0)) / vec2(1800.0);
    ...
    float displacement = sin(angle * 10.0 - _breath) * 0.1;
    ...
    fragColor = (displacedDistanceToCenter <= _radius) ? vec4(0.6, 0.5, 0.0, 1.0) : vec4(0.0, 0.0, 0.0, 1.0);
